...
class DumpItApp(tk.Tk):
    ...
    def _build_apply_patch_tab(self, parent: ttk.Frame, pad: dict) -> None:
        ...
        ttk.Label(opt_grid, text="Engine").grid(row=0, column=0, sticky="w", padx=6, pady=4)
        ...
        engine_box.grid(row=0, column=1, sticky="w", padx=6, pady=4)

        ttk.Label(opt_grid, text="Strip level (-p)").grid(row=1, column=0, sticky="w", padx=6, pady=4)
        ttk.Entry(opt_grid, textvariable=self.patch_strip_level, width=8).grid(row=1, column=1, sticky="w", padx=6, pady=4)
        ttk.Checkbutton(opt_grid, text="Reverse patch (-R)", variable=self.patch_reverse).grid(row=1, column=2, sticky="w", padx=16, pady=4)
        ttk.Checkbutton(opt_grid, text="Auto-detect target root / strip level", variable=self.patch_auto_detect).grid(row=2, column=0, columnspan=3, sticky="w", padx=6, pady=4)
        ttk.Checkbutton(opt_grid, text="Backup existing touched files before apply", variable=self.patch_backup).grid(row=3, column=0, columnspan=3, sticky="w", padx=6, pady=4)
